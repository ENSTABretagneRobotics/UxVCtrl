...
Ontrak.o: ./Hardware/Ontrak.cpp ./Hardware/Ontrak.h
	$(CXX) $(CXXFLAGS) -c $<
...
Roboteq.o: ./Hardware/Roboteq.cpp ./Hardware/Roboteq.h
	$(CXX) $(CXXFLAGS) -c $<
...
RoboteqInterface.o: RoboteqInterface.cpp RoboteqInterface.h
	$(CXX) $(CXXFLAGS) -c $<
...
VectorNavInterface.o: VectorNavInterface.cpp VectorNavInterface.h
	$(CXX) $(CXXFLAGS) -c $<
