...
move /Y %USERPROFILE%\Downloads\UxVCtrl_mingw13_x86.exe "%UDK_USER_PATH%\Compatibility mode\Windows\"
...
move /Y %USERPROFILE%\Downloads\UxVCtrl_mingw13_x64.exe "%UDK_USER_PATH%\Compatibility mode\Windows_x64\"
...
move /Y %USERPROFILE%\Downloads\UxVCtrl_compat_macos_sonoma_x86_64 "%UDK_USER_PATH%\Compatibility mode\macOS\"
move /Y %USERPROFILE%\Downloads\UxVCtrl_macos_sonoma_x86_64 "%UDK_USER_PATH%\Compatibility mode\macOS\"
