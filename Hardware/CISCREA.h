	...
	case VENI_ROBID:
		{
			...
			case 1:
				//AvBb
				up = calib_rov1_moteur_deadzone_AvBb_up;
				dn = calib_rov1_moteur_deadzone_AvBb_dn;
				clockwise = calib_rov1_moteur_clockwise_AvBb;
				break;
			case 2:
				//AvTb
				up = calib_rov1_moteur_deadzone_AvTb_up;
				dn = calib_rov1_moteur_deadzone_AvTb_dn;
				clockwise = calib_rov1_moteur_clockwise_AvTb;
				break;
			case 3:
				//ArTb
				up = calib_rov1_moteur_deadzone_ArTb_up;
				dn = calib_rov1_moteur_deadzone_ArTb_dn;
				clockwise = calib_rov1_moteur_clockwise_ArTb;
				break;
			case 4:
				//ArBb
				up = calib_rov1_moteur_deadzone_ArBb_up;
				dn = calib_rov1_moteur_deadzone_ArBb_dn;
				clockwise = calib_rov1_moteur_clockwise_ArBb;
				break;
			case 5:
				//V
				up = calib_rov1_moteur_deadzone_V_up;
				dn = calib_rov1_moteur_deadzone_V_dn;
				clockwise = calib_rov1_moteur_clockwise_V;
				break;
			}
			center = (up+dn)/2;
			break;
	...
	case VEDI_ROBID:
		{
			...
			case 1:
				//AvBb
				up = calib_rov2_moteur_deadzone_AvBb_up;
				dn = calib_rov2_moteur_deadzone_AvBb_dn;
				clockwise = calib_rov2_moteur_clockwise_AvBb;
				break;
			case 2:
				//AvTb
				up = calib_rov2_moteur_deadzone_AvTb_up;
				dn = calib_rov2_moteur_deadzone_AvTb_dn;
				clockwise = calib_rov2_moteur_clockwise_AvTb;
				break;
			case 4:
				//ArBb
				up = calib_rov2_moteur_deadzone_ArBb_up;
				dn = calib_rov2_moteur_deadzone_ArBb_dn;
				clockwise = calib_rov2_moteur_clockwise_ArBb;
				break;
			case 3:
				//ArTb
				up = calib_rov2_moteur_deadzone_ArTb_up;
				dn = calib_rov2_moteur_deadzone_ArTb_dn;
				clockwise = calib_rov2_moteur_clockwise_ArTb;
				break;
			case 5:
				//V
				up = calib_rov2_moteur_deadzone_V_up;
				dn = calib_rov2_moteur_deadzone_V_dn;
				clockwise = calib_rov2_moteur_clockwise_V;
				break;
			}
			center = (up+dn)/2;
			break;
	...
	case VICI_ROBID:
		{
			...
			case 1:
				//AvBb
				up = calib_rov3_moteur_deadzone_AvBb_up;
				dn = calib_rov3_moteur_deadzone_AvBb_dn;
				clockwise = calib_rov3_moteur_clockwise_AvBb;
				break;
			case 2:
				//AvTb
				up = calib_rov3_moteur_deadzone_AvTb_up;
				dn = calib_rov3_moteur_deadzone_AvTb_dn;
				clockwise = calib_rov3_moteur_clockwise_AvTb;
				break;
			case 3:
				//ArTb
				up = calib_rov3_moteur_deadzone_ArTb_up;
				dn = calib_rov3_moteur_deadzone_ArTb_dn;
				clockwise = calib_rov3_moteur_clockwise_ArTb;
				break;
			case 4:
				//ArBb
				up = calib_rov3_moteur_deadzone_ArBb_up;
				dn = calib_rov3_moteur_deadzone_ArBb_dn;
				clockwise = calib_rov3_moteur_clockwise_ArBb;
				break;
			case 5:
				//V
				up = calib_rov3_moteur_deadzone_V_up;
				dn = calib_rov3_moteur_deadzone_V_dn;
				clockwise = calib_rov3_moteur_clockwise_V;
				break;
			}
			center = (up+dn)/2;
			break;
